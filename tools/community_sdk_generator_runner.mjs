...
function writeSdkManifest({ family, inputPath, baseUrl, languages }) {
  ...
  const manifest = {
    ...
    managedBy: "tools/community_sdk_generator_runner.mjs",
  };
...
function syncAssembly(family, inputPath) {
  ...
  assembly.sdkOwner = "sdkwork-community";
...
export function runCommunitySdkGenerator(family, argv) {
