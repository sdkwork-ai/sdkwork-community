...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `community-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `community-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `community-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `community.sdkwork.com` | 443 ssl + 80 |
