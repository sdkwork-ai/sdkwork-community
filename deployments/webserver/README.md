...
Module `sdkwork-community` · runtime code `community` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `community-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `community-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `community-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `community-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `community.sdkwork.com` | 443 ssl + 80 |
