# Runbook — sdkwork-community deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-community-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-community/bundle`, loads the image, starts
